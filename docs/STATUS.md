...
**Updated:** 2026-07-16 · **Branch:** `main` · **Tests:** 264 examples, 0 failures · **Runtime deps:** none required (`ruby-mysql` is a *soft* dep — without it only the beads provider is off)
...
> ✅ **All work is committed on `main`** (working tree clean, 264 ex green). **Resume at
